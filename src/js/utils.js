...
// regexpHelper
var regexpHelper = {};
myUtils.regexpHelper = regexpHelper;
...
// puzzleHelper
var puzzleHelper = {};
myUtils.puzzleHelper = puzzleHelper;
puzzleHelper.pickCoincidedGroup = function(data, predicate, comparator){
  ...
  predicate = (typeof predicate !== 'function' ? defaultPredicate : predicate);
  comparator = (typeof comparator !== 'function' ? defaultComparator : comparator);
  if(!data || !data.length){
    return res;
  }
